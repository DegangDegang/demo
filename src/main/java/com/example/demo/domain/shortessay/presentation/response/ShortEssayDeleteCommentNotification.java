...
@Getter
public class ShortEssayDeleteCommentNotification implements DeleteNotificationInfo {
	...
	@Builder
	public ShortEssayDeleteCommentNotification(UserInfoVO receiver, UserInfoVO sender, NotificationType notificationType,
